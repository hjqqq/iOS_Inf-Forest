...
{ 
    ...
    _model = [[ViewModel alloc] init]; //call the over riden method
    
    //create the UV image
    //uvString= [get3D getUV];
    ...
    //textureString=[get3D getTexture];
    ...
    self.view.transform = CGAffineTransformMakeRotation(4.71238898);
    //self.CoolView.transform = CGAffineTransformMakeRotation(4.71238898);
    //[[self view] sizeToFit];
